  ...
  return (
    <main className="max-w-container-max mx-auto px-3 sm:px-6 py-3 sm:py-8 space-y-4 sm:space-y-10 flex-grow w-full">
      ...
      >
          ...
          {HERO_SLIDES.map((slide) => (
            ...
            >
              ...
              <div className="relative z-10 max-w-xl space-y-2 sm:space-y-4">
                ...
                >
                  <span className="material-symbols-outlined text-[11px] sm:text-sm">{slide.icon}</span>
                ...
                <div className="flex items-center gap-2 pt-1 sm:pt-3">
                  ...
                  >
                    <span className="material-symbols-outlined text-sm sm:text-xl">shopping_bag</span>
                    <span>{slide.cta}</span>
                  </button>
                  <Link
                    to={slide.link}
        ...
        >
          <span className="material-symbols-outlined text-base sm:text-2xl">chevron_left</span>
        </button>
        ...
        <button
          ...
          title="Next Banner"
        >
          <span className="material-symbols-outlined text-base sm:text-2xl">chevron_right</span>
        </button>
              ...
              >
                ...
                <div className="relative w-full aspect-square bg-surface-container dark:bg-slate-700/50 overflow-hidden">
                  ...
                  <button
                    ...
                    title="Wishlist"
                  >
                    <span className={`material-symbols-outlined text-sm sm:text-base ${isWishlisted ? "filled text-red-500" : ""}`}>
                      favorite
                    </span>
                  </button>
                </div>
                ...
                <div className="p-2.5 sm:p-4 flex-grow flex flex-col justify-between space-y-1.5 sm:space-y-2">
                  ...
                  <div className="pt-1.5 flex items-center justify-between border-t border-outline-variant/20">
                    ...
                    <button
                      ...
                      title="Add to Cart"
                    >
                      <span className="material-symbols-outlined text-xs sm:text-base">add_shopping_cart</span>
